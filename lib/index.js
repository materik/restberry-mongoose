...
Mongoose.prototype.use = function(restberry, next) {
    var self = this;
    restberry.connections.db = self;
    next(mongoose);
};

Mongoose.prototype.addMethods = function(schema, methods) {
...
Mongoose.prototype.addStatics = function(schema, statics) {
...
Mongoose.prototype.get = function(name) {
    try {
...
Mongoose.prototype.apply = function(name, schema) {
